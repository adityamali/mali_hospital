...
function page() {
  return (
      <div className='flex flex-col justify-center items-center gap-20'>
        <div className='grid grid-cols-1 md:grid-cols-2 w-[96vw] gap-10 mt-40'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 grid-flow-row gap-10'>
                  ...
                  <div className='flex flex-col gap-2 border border-gray-200 rounded-3xl p-4 bg-gray-50 hover:shadow-xl cursor-pointer transition-time' onClick={() => {window.location.href = 'mailto:drmalichildrenshospitalmiraj@gmail.com'}}>
                    ...
                    <span className='text-xs font-bold'>drmalichildrenshospitalmiraj@gmail.com</span>
                  </div>
